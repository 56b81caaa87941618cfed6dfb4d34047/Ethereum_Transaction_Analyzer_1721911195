...
Vue.component("purple_background_cta_component_1721911196", {
    template: `
    <section id="cta-section-container" class="flex">
        <div id="sidebar" class="w-64 h-screen bg-purple-100 p-6 shadow-lg">
            <nav>
                <ul class="space-y-4">
                    <li><a href="#" class="text-purple-800 hover:text-purple-600">Home</a></li>
                    <li><a href="#" class="text-purple-800 hover:text-purple-600">About</a></li>
                    <li><a href="#" class="text-purple-800 hover:text-purple-600">Contact</a></li>
                </ul>
            </nav>
        </div>
        <div id="section-container" class="flex-1 max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3" :class="[transparentTextStyle, contentSubtitleStyle]">Comprehensive Analytics for Ethereum Transactions</div></div>
                    ...
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8" :class="[contentBodyStyle]">Stay ahead of the curve with our cutting-edge Ethereum transaction analysis platform. Gain valuable insights into the latest on-chain activities and make informed decisions for your business or investment strategies.</p></div>
