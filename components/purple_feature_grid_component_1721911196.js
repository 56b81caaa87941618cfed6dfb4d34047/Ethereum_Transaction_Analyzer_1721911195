...
Vue.component("purple_feature_grid_component_1721911196", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our advanced transaction monitoring system that tracks new Ethereum transactions as they occur, providing you with up-to-the-minute insights and analysis.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
        ...
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Tailor the app to your specific needs by setting up custom alerts and notifications for transactions that match your predefined criteria, ensuring you never miss a beat.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Intuitive Data Visualization</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Gain valuable insights through our intuitive data visualization tools, which transform complex transaction data into clear and concise charts, graphs, and dashboards, making it easy to identify patterns and trends.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 font-medium" :class="textSecondaryStyle">Integration with Blockchain Explorers</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Seamlessly integrate with popular blockchain explorers, allowing you to cross-reference transaction data and dive deeper into the intricacies of each transaction.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our app is built on a secure and reliable infrastructure, ensuring your data remains safe and accessible at all times, giving you peace of mind when analyzing sensitive on-chain transactions.</p></div>
        </div>
    </div>`,
        data() {
            return {
